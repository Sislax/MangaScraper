...
namespace MangaScraper.Services
{
    public class MangaScraperService : IMangaScraperService
    {
        ...
        public IWebDriver CreateDriverWithExtensions(ChromeOptions opt)
        {
            try
            {
        ...
        public IEnumerable<string> GetArchivePageUrls(Settings settings)
        {
            try
            {
        ...
        public IWebDriver StartMangaScraping()
        {
            try
            {
        ...
        public IEnumerable<Manga> CreateManga(IWebDriver driver)
        {
            try
            {
        ...
        public IEnumerable<string> GetChapterPagesOfManga(IWebDriver driver)
        {
            try
            {
        ...
        public IEnumerable<Manga> GetInfoManga(IWebDriver driver)
        {
            List<Manga> mangas = new List<Manga>();
        ...
        public async Task DownloadImgs(HttpClient downloader, string fileToDownload, string imgPath)
        {
            try
            {
        ...
        public async Task GetManhwaChapterImgs(IEnumerable<string> urlsCapitoli, IWebDriver driver, Manga manga, HttpClient downloader)
        {
        ...
        public async Task GetMangaChapterImgs(IEnumerable<string> urlsCapitoli, IWebDriver driver, Manga manga, HttpClient downloader)
        {
            List<string> urlsCapitoliString = urlsCapitoli.ToList();
        ...
        public async Task GetOneShotChapterImgs(IEnumerable<string> urlsCapitoli, IWebDriver driver, Manga manga, HttpClient downloader)
        {
            List<string> urlsCapitoliString = urlsCapitoli.ToList();
